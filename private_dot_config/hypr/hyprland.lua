...
local menu        = "/usr/bin/rofi -show drun -run-command 'uwsm app -- {cmd}'"
local lock        = "/usr/bin/hyprlock"
...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("uwsm app -- hyprshutdown"))
...
hl.bind(mainMod .. " + F12", hl.dsp.exec_cmd("loginctl lock-session"))
...
hl.window_rule({
    name = "move-thunderbird",
    match = { class = "org.mozilla.Thunderbird" },
    workspace = "10 silent"
})

hl.window_rule({
    name = "move-steam-windows",
    match = { class = "(steam).*" },
    workspace = "8 silent"
})
